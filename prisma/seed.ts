...
async function main() {
  ...
  await Promise.all([
    ...
    prisma.campus.upsert({ where: { id: 'campus-tuk' }, update: {}, create: { id: 'campus-tuk', name: 'Technical University of Kenya', city: 'Nairobi', latitude: -1.2833, longitude: 36.8167 } }),
    prisma.campus.upsert({ where: { id: 'campus-jkuat' }, update: {}, create: { id: 'campus-jkuat', name: 'JKUAT', city: 'Juja', latitude: -1.0917, longitude: 37.0144 } }),
  ...
  const hostels = [
    ...
    // KU
    {
      ...
      name: 'SafeStay KM Market', address: 'KM Market, Kahawa West',
      description: 'Male hostel at KM Market, 5 minutes from KU main gate. En-suite rooms, gym access, rooftop terrace.',
    ...
    },
    {
      ...
      name: 'SafeStay Kahawa West', address: 'KM Market, Kahawa West',
      description: 'Affordable mixed hostel at KM Market near KU. Clean rooms, reliable water supply, communal lounge.',
    ...
    },
    {
      ...
      name: 'SafeStay Kahawa', address: 'KM Market, Kahawa West',
      description: 'Female-only hostel at KM Market, 8 minutes from KU. Homely atmosphere, shared kitchen, reliable water.',
    ...
    // TUK
    {
      id: 'hostel-5', ownerId: o2.id, campusId: 'campus-tuk',
      name: 'SafeStay South B', address: 'South B, Nairobi',
      description: 'Male-only hostel in South B, 8 minutes from TUK. Secure, clean rooms with fast Wi-Fi and 24/7 security.',
      latitude: -1.3000, longitude: 36.8300, gender: 'MALE' as const,
      amenities: ['Wi-Fi', 'Security', 'Water', 'Laundry', 'CCTV'],
      verified: true, status: 'LIVE' as const, minutesToCampus: 8,
      images: [{ url: '/hostel-2.jpg', isCover: true }, { url: '/hostel-3.jpg', isCover: false }],
      rooms: [
        { type: 'SINGLE' as const, pricePerMonth: 7500, pricePerTerm: 22500, capacity: 1, availableUnits: 6 },
        { type: 'SHARED' as const, pricePerMonth: 6500, pricePerTerm: 19500, capacity: 2, availableUnits: 10 },
        { type: 'EN_SUITE' as const, pricePerMonth: 9000, pricePerTerm: 27000, capacity: 1, availableUnits: 2 },
      ],
    },
    {
      id: 'hostel-6', ownerId: o3.id, campusId: 'campus-tuk',
      name: 'SafeStay Upper Hill', address: 'Upper Hill, Nairobi',
      description: 'Female-only hostel in Upper Hill, 10 minutes from TUK. Quiet, well-managed with backup generator and CCTV.',
      latitude: -1.2950, longitude: 36.8150, gender: 'FEMALE' as const,
      amenities: ['Wi-Fi', 'Generator', 'CCTV', 'Kitchen', 'Water', 'Security'],
      ...
      rooms: [
        ...
        { type: 'BEDSITTER' as const, pricePerMonth: 8500, pricePerTerm: 25500, capacity: 1, availableUnits: 3 },
      ],
    },
    // JKUAT
    {
      id: 'hostel-9', ownerId: o4.id, campusId: 'campus-jkuat',
      name: 'SafeStay Gate D', address: 'Gate D Road, Juja',
      description: 'Mixed hostel right along JKUAT Gate D. 3 minutes to campus. Popular with engineering students. Fibre internet.',
      latitude: -1.0930, longitude: 37.0160, gender: 'MIXED' as const,
      amenities: ['Fibre Wi-Fi', 'Water', 'Security', 'Study room', 'Laundry'],
      ...
      rooms: [
        ...
        { type: 'EN_SUITE' as const, pricePerMonth: 8500, pricePerTerm: 25500, capacity: 1, availableUnits: 3 },
      ],
    },
    {
      id: 'hostel-19', ownerId: o5.id, campusId: 'campus-jkuat',
      name: 'SafeStay Juja', address: 'Gate D Road, Juja',
      description: 'Female-only hostel near JKUAT Gate D. Safe, clean, with a resident caretaker and shared kitchen.',
      latitude: -1.0910, longitude: 37.0150, gender: 'FEMALE' as const,
      amenities: ['Wi-Fi', 'Kitchen', 'Security', 'Water', 'CCTV'],
      verified: true, status: 'LIVE' as const, minutesToCampus: 5,
      ...
      rooms: [
        ...
        { type: 'BEDSITTER' as const, pricePerMonth: 8000, pricePerTerm: 24000, capacity: 1, availableUnits: 2 },
      ],
    },
    // MKU
    {
