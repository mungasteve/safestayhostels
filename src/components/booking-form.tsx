...
export default function BookingForm({
  ...
  function openWhatsApp() {
    ...
    const msg = `Hi SafeStay, I'd like to book a ${roomLabel[roomType] ?? roomType} at *${hostelName}* for KES ${price.toLocaleString()}/month. Please assist.`
    window.open(`https://wa.me/254734345156?text=${encodeURIComponent(msg)}`, '_blank')
  }
